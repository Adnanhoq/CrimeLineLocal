...
function Home() {
  ...
  const [cases, setCases] = useState<FormData[]>(() => {
    ...
    return savedCases
      ...
      : [
          {
            id: "1",
            caseName: "Bank_Robbery",
            type: "Robber",
            description: "Caps Bank was robbed on Monday 14th October 2024",
          },
        ];
  });
  ...
  useEffect(() => {
    if (newCase) {
      setCases((prevCases) => {
        const caseExists = prevCases.some(
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <CrimeLineHeader
        title="Crime Line"
        showButton={true}
        navigatePath={"/new-investigation"}
        buttonText={"Create New Investigations"}
      />
